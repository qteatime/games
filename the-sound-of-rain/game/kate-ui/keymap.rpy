define config.keymap = dict(
  ...
  screenshot = ["K_F12"],
  toggle_afm = [],
  toggle_fullscreen = ["alt_K_RETURN", "K_F11"],
  game_menu = ["K_LSHIFT", "K_ESCAPE", "mouseup_3"],
  hide_windows = ["mouseup_2", "K_h"],
  # developer
  launch_editor = [],
  dump_styles = [],
  reload_game = ["K_F5"],
  ...
  progress_screen = ["K_F2"],
  console = [ 'shift_K_o', 'alt_shift_K_o' ],
  console_older = [ 'K_UP', 'repeat_K_UP' ],
  console_newer = [ 'K_DOWN', 'repeat_K_DOWN'],
  director = [ 'noshift_K_d' ],
  performance = [ 'shift_K_F3' ],
  image_load_log = [ 'shift_K_F4' ],
  profile_once = [ 'shift_K_F8' ],
  memory_profile = [ 'shift_K_F7' ],
  # accessibility
  accessibility = ["K_F4"],
  self_voicing = [],
  clipboard_voicing = [],
